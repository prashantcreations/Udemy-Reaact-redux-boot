 ...
 * "project")
 * 
 * @JoinColumn(name = "project_id") ArrayList<User1> user ;
 * 
 ...
 * 
 * public ArrayList<User1> getUser() { return user; }
 * 
 * public void setUser(ArrayList<User1> user) { this.user = user; }
 * 
 * 
 * 
 * }
